...
public class TurfWar extends PApplet {
    ...
    class Player {
        ...
        void update() {
            ...
            if (moveUp && y > statsBoardLine) {
                y-=speed;
            } else if(moveDown&& y < 900-playerSize){
            	y+=speed;
            }else if(moveRight&& x < 900-playerSize){
            	x+=speed;
    ...
    public void setup() {
         ...
         */
 player1= new Player(0,400,30,80,Color.WHITE.getRGB(),W,A,S,D); 
 player2= new Player(820,400,30,80,Color.BLACK.getRGB(),UP,LEFT,DOWN,RIGHT);
